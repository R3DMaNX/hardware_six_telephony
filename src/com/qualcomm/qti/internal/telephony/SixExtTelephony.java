...
public class SixExtTelephony extends IExtTelephony.Stub {
    ...
    private static SixExtTelephony sInstance;
    ...
    public static SixExtTelephony getInstance(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
        if (sInstance == null) {
            sInstance = new SixExtTelephony(context, phones, commandsInterfaces);
        }

        return sInstance;
    }

    private SixExtTelephony(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
